...
| [Pi-Mono](https://github.com/badlogic/pi-mono) | TypeScript agent toolkit | A minimalist, highly extensible AI Agent Toolkit built in TypeScript, deliberately engineered to avoid the bloat of larger default frameworks. | Emerging |
